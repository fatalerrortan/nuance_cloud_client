from request_json_dict.nuance_dict_ASR_13 import *
import re
import os
import json
from io import BytesIO
import ssl
import http.client_nuance
...
class Request(object):
    ...
    def add_json_parameter(self, name, paramName, data):
        # for binary dict input you need to convert the dict into a json string first
...
if __name__ == "__main__":
    ...
    for file in modi_files:
        ...
        conn = http.client_nuance.HTTPSConnection(host, port=443, context=ssl._create_unverified_context())
        conn.set_debuglevel(0) # set 2 to verbose
